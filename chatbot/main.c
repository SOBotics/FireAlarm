...
int main(int argc, const char * argv[]) {
    ...
    Command *commands[] = {
        ...
        createCommand("stop", 1, stopBot),
        createCommand("reboot", 0, rebootBot),
        createCommand("kill", 1, forceStopBot),
        createCommand("check post *", 0, checkPostCallback),
        createCommand("tp", 0, truePositive),
        createCommand("fp", 0, falsePositive),
        createCommand("t", 0, truePositive),
        createCommand("f", 0, falsePositive),
        ...
        createCommand("tpr", 0, truePositiveRespond),
        createCommand("fpr", 0, falsePositiveRespond),
        ...
        createCommand("tr", 0, truePositiveRespond),
        ...
        createCommand("privilege user *", 1, addUserPriv),
